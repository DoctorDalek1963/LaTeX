...
\fill[gray,opacity=0.3] (0,0) -- (3,0) -- (3,3) arc[start angle=90, end angle=180, radius=3];
\fill[gray,opacity=0.3] (0,2) -- (0,4) -- (2,4) arc[start angle=0, end angle=-90, radius=2];
\fill[gray,opacity=0.3] (3,3) -- (3,4) -- (2,4) arc[start angle=180, end angle=270, radius=1];
