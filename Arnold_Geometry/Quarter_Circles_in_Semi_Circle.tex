...
\fill[gray,opacity=0.3] ({-sqrt(3)},2) -- ({-sqrt(3)},0) arc[start angle=270, end angle=360, radius=2] -- cycle;
\fill[gray,opacity=0.3] ({sqrt(3)},0) -- ({sqrt(3)},2) arc[start angle=90, end angle=180, radius=2] -- cycle;
\end{tikzpicture}
\hspace{\fill}
