...
\addcontentsline{toc}{section}{Year 1 Pure}
\subfile{sections/y1p/binom.tex}
\newpage
\subfile{sections/y1p/calc.tex}
\newpage
\subfile{sections/y1p/exp.tex}
\newpage
\subfile{sections/y1p/trig.tex}
\newpage
