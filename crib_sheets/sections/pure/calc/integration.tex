...
\begin{tikzpicture}[
	...
	\node (t6-words) [words, below=of t5-words] {
		Integrating by parts is the most complicated method, and should be avoided wherever possible. Use the following formula:
		\begin{empheq}[box=\formulaBookBox]{align*}
			\int u \frac{\diffd v}{\diffd x} \diffd x = uv - \int v \frac{\diffd u}{\diffd x} \diffd x
		\end{empheq}
